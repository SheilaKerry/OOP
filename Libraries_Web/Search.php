            ...
            <div class="w3-half">
                <div class="w3-white">
                    ...
                    <!--                <a href='advanceSearch.php'>Advanced search </a>
                                        <form action="" method="post">
                                            <div class="form-row" >
                                                <input type="string" name="search" class="form-control form-control-lg" id="searchInput" placeholder="search">
                                            </div>
                                            <div class="form-group">
                                                <button class = "form-control form-control-lg" type="submit" value="Search" class="btn btn-secondary btn-lg">Search now</button>
                                            </div>-->
                </div>
            </div>
        </div>
