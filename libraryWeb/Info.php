...
<html>
   ...
   <!-- <link href="style_library.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="w3-display-container">
        <img src="Images/bookshelves.jpg" alt="bookshelves" style="width:100%;min-height:250px;max-height:20px;">
    ...
    <div class="container padding-64 center" id="team">
     ...
     <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 ">  
                <img src="Images/Kylie.jpeg" alt="Kylie" style="width:100%" class="img-fluid">
                <h3>Kylie</h3>
                <p></p>
            </div>

           <div class="col-sm-4 ">
                <img src="Images/Kim.jpeg" alt="Kim" style="width:100%" class="img-fluid">
                <h3>Kim</h3>
                <p></p>
            </div>

          <div class="col-sm-4 ">
                <img src="Images/Gaby.jpeg" alt="Gaby" style="width:100%" class="img-fluid">
                <h3>Gaby</h3>
                <p></p>
            </div>

           <div class="col-sm-4 ">
                <img src="Images/Sheila.jpg" alt="Sheila" style="width:100%" class="img-fluid">
                <h3>Sheila</h3>
                <p></p>
            </div>
